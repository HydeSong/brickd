...
describe('Tree Component', () => {
  ...
  test('respects disabled nodes', () => {
    ...
    const disabledNode = screen.getByText('父节点 1').closest('.treeNodeContent');
  ...
  test('supports defaultSelectedKeys', () => {
    render(<Tree data={treeData} defaultExpandedKeys={['1']} defaultSelectedKeys={['1-1']} />);
    const selectedNode = screen.getByText('子节点 1-1').closest('.treeNodeContent');
