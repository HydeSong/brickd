...
import Skeleton, { SkeletonText, SkeletonButton, SkeletonImage, SkeletonCard, SkeletonList } from '../index';
...
describe('Skeleton Component', () => {
  ...
  test('renders with custom className and style', () => {
    const { container } = render(
      <Skeleton className="custom-skeleton" style={{ backgroundColor: '#f0f0f0' }} />
    );
