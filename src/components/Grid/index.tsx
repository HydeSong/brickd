    ...
    const addResponsiveClass = (
      ...
      if (typeof value === 'number') {
        ...
        if (value.span !== undefined)
          classes.push(styles[`${prefix}-span-${value.span}`]);
        if (value.offset !== undefined)
          classes.push(styles[`${prefix}-offset-${value.offset}`]);
        if (value.push !== undefined)
          classes.push(styles[`${prefix}-push-${value.push}`]);
        if (value.pull !== undefined)
          classes.push(styles[`${prefix}-pull-${value.pull}`]);
      }
    };
