...
describe('Timeline Component', () => {
  ...
  test('renders timeline with pending state', () => {
    ...
    expect(
      booleanContainer.querySelector('.timelineItemContentInner'),
    ...
    expect(
      customContainer.querySelector('.timelineItemContentInner'),
    ).toHaveTextContent('Item 1');
    expect(
      customContainer.querySelector('[data-testid="custom-pending"]'),
    ).toBeInTheDocument();
  });
