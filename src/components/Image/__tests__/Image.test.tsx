...
describe('Image Component', () => {
  test('renders image with src and alt', () => {
    render(
      <Image src="https://via.placeholder.com/300x200" alt="Test Image" />,
    );
  ...
  test('applies lazy loading', () => {
    const { container } = render(
      <Image src="https://via.placeholder.com/300x200" alt="Test Image" lazy />,
    );
    const imgElement = container.querySelector('img');
  ...
  test('renders fallback on error', () => {
    ...
    render(<Image src="invalid-url" alt="Test Image" fallback={fallback} />);
