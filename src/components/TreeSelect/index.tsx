    ...
    >
      <div
        className={`${styles.treeSelectTrigger} ${
          open ? styles.treeSelectTriggerOpen : ''
        }`}
        onClick={handleToggle}
      >
        <span className={styles.treeSelectValue}>{getDisplayValue()}</span>
        <span
          className={`${styles.treeSelectArrow} ${
            open ? styles.treeSelectArrowOpen : ''
          }`}
        >
          {open ? '▼' : '►'}
        </span>
