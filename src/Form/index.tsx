...
export const FormItem: React.FC<FormItemProps> = ({
    ...
    if (name && context) {
      const field: FormField = {
        ...
        validate: async () => {
          // 简单验证：必填
          if (required && !value) {
            const errorMessage = context.validateMessages.required
  ...
  const renderLayout = () => {
    ...
    if (context?.layout === 'horizontal') {
      return (
        <div className={`${formItemClassName} ${styles.formLayoutHorizontal}`} style={style}>
    ...
    if (context?.layout === 'inline') {
      return (
        <div className={`${formItemClassName} ${styles.formLayoutInline}`} style={style}>
          <label className={styles.formItemLabel}>
            {required && <span className={styles.formItemRequired}>*</span>}
            {label}
          </label>
