          ...
          'carousel-demo-0': {
                        ...
                        switch ((l.prev = l.next)) {
                          case 0:
                            return (
                              ...
                              (l.next = 3),
                              n.e(365).then(n.bind(n, 30365))
                            );
                          case 3:
                            return (
                              (o = l.sent),
                              (a = o.default),
                              l.abrupt('return', { default: r })
                            );
                          case 6:
                          case 'end':
                            return l.stop();
            ...
            asset: {
              ...
              dependencies: {
                'index.tsx': {
                  type: 'FILE',
                  value: `import Carousel from './index';
...
export default CarouselControlledDemo;`,
            ...
            context: {
              ...
              '../Button.tsx': x,
              react: I || (I = n.t(e, 2)),
              '/Users/hyde/Documents/Workspace/brickd/src/Space/index.tsx': C,
              '/Users/hyde/Documents/Workspace/brickd/src/Button/index.tsx': x,
            },
            renderOpts: {
              compile: (function () {
                var s = i()(
...
export default CarouselCustomStyleDemo;`,
    ...
    9033: function (m, c, n) {
      ...
      `,
            ...
            style: {
              gap: e === 'horizontal' ? ''.concat(u, 'px') : void 0,
              rowGap: e === 'vertical' ? ''.concat(u, 'px') : void 0,
              columnGap: e === 'vertical' ? void 0 : ''.concat(u, 'px'),
            },
            children: a,
          });
        },
      ...
      function y(h, v) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (i = 0; i < e.length; i++)
            (p = e[i]),
              !(v.indexOf(p) >= 0) &&
                Object.prototype.propertyIsEnumerable.call(h, p) &&
                (d[p] = h[p]);
        }
        return d;
      }
