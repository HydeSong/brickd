          ...
          'calendar-demo-0': {
                        ...
                        switch ((a.prev = a.next)) {
                          case 0:
                            return (
                              ...
                              (a.next = 3),
                              e.e(7140).then(e.bind(e, 17140))
                            );
                          case 3:
                            return (
                              (t = a.sent),
                              (s = t.default),
                              a.abrupt('return', { default: d })
                            );
                          case 6:
                          case 'end':
                            return a.stop();
            ...
            asset: {
              ...
              dependencies: {
                'index.tsx': {
                  type: 'FILE',
                  value: `import Calendar from './index';
                              ...
                              (d = function () {
                                ...
                                return (
                                  ...
                                  l.createElement(
                                    'div',
                                    { style: { width: '300px' } },
                                    l.createElement(s, { defaultValue: I }),
                                  )
                                );
                              }),
                              (a.next = 3),
...
export default CalendarCustomStyleDemo;`,
    ...
    71159: function (c, p, e) {
      ...
      const h = [
        ...
        { value: 'onChange', paraId: 2, tocIndex: 3 },
        {
          value:
            ' \u5C5E\u6027\u5B9E\u73B0\u53D7\u63A7\u6A21\u5F0F\uFF0C\u5916\u90E8\u53EF\u4EE5\u63A7\u5236\u9009\u4E2D\u7684\u65E5\u671F\u3002',
          paraId: 2,
          tocIndex: 3,
        },
        { value: '\u901A\u8FC7 ', paraId: 3, tocIndex: 4 },
        { value: 'defaultValue', paraId: 3, tocIndex: 4 },
        {
          value:
            ' \u5C5E\u6027\u8BBE\u7F6E\u9ED8\u8BA4\u9009\u4E2D\u7684\u65E5\u671F\uFF0C\u7EC4\u4EF6\u5185\u90E8\u7BA1\u7406\u72B6\u6001\u3002',
          paraId: 3,
          tocIndex: 4,
        },
        ...
        { value: 'value', paraId: 5, tocIndex: 7 },
        {
          value:
            '\u9009\u4E2D\u7684\u65E5\u671F\uFF08\u53D7\u63A7\u6A21\u5F0F\uFF09',
          paraId: 5,
        ...
        { value: 'Date', paraId: 5, tocIndex: 7 },
        { value: '-', paraId: 5, tocIndex: 7 },
        { value: 'defaultValue', paraId: 5, tocIndex: 7 },
        {
          value:
            '\u9ED8\u8BA4\u9009\u4E2D\u7684\u65E5\u671F\uFF08\u975E\u53D7\u63A7\u6A21\u5F0F\uFF09',
          paraId: 5,
        ...
        { value: '(date: Date) => void', paraId: 5, tocIndex: 7 },
        { value: '-', paraId: 5, tocIndex: 7 },
      ...
      function C(v, y) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (i = 0; i < l.length; i++)
            (f = l[i]),
              !(y.indexOf(f) >= 0) &&
                Object.prototype.propertyIsEnumerable.call(v, f) &&
                (r[f] = v[f]);
        }
        return r;
      }
