    ...
    93548: function (A, o, e) {
      ...
      var g = e(48305),
        ...
        i = {
          ...
          version: '0.0.1',
          license: 'MIT',
          authors: ['hyde.song@icloud.com'],
        },
        u = 'browser',
        d = void 0,
        c = {
          footer:
            'Copyright \xA9 2026 | Powered by <a href="https://d.umijs.org" target="_blank" rel="noreferrer">dumi</a>',
      ...
      function T() {
        var b = (0, r.pC)(),
          ...
          f = m[0],
          h = m[1],
          p = (0, n.useRef)(r.m8.location.pathname);
        ...
        var E = n.useMemo(
          ...
          [i, u, l, a, s.k, f, h, d, c, v],
        );
        return (0, k.jsx)(x.D.Provider, { value: E, children: b });
      }
    },
  },
]);
